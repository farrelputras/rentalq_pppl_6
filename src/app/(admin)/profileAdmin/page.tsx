...
import Navbar from '@/ui/NavbarAdmin'; // sesuaikan path kalau berbeda
            ...
            <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
              ...
              <form onSubmit={handleNameSubmit} className="mt-4 space-y-4">
                ...
                <div className="flex justify-end space-x-4 mt-4">
                  <button type="button" onClick={() => setShowNameModal(false)} className="px-6 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition">
                    Cancel
                  </button>
                  <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">
                    Confirm
                  </button>
                </div>
              </form>
          ...
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
              ...
              <form onSubmit={handlePhoneSubmit} className="mt-4 space-y-4">
                ...
                />
                <div className="flex justify-end space-x-4 mt-4">
                  <button type="button" onClick={() => setShowPhoneModal(false)} className="px-6 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition">
                    Cancel
                  </button>
                  <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">
                    Confirm
          ...
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl shadow-lg w-full max-w-sm p-6">
              ...
              <div className="flex justify-end space-x-4 mt-6">
                <button onClick={() => setShowLogOutModal(false)} className="px-6 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition">
                  Cancel
                </button>
                <button onClick={handleLogOutConfirm} className="px-6 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">
                  Yes
                </button>
              </div>
            </div>
